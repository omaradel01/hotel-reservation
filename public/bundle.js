...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"apiUrl.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var apiUrl = 'http://127.0.0.1:4000/api/v1';
...
var showAlert = function showAlert(type, msg) {
  ...
  window.location.pathname === '/login' ? document.querySelector('body > div > div > div > div').insertAdjacentHTML('afterbegin', markup) : document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
...
function email_validation() {
  ...
  if (emails.split(',').includes(input.value)) {
    document.getElementById('demo2').innerHTML = '&#x26A0;This email is taken, please try another one.';
...
function username_validation() {
  ...
  if (usernames.split(',').includes(input.value)) {
    document.getElementById('demo').innerHTML = '&#x26A0;This username is taken, please try another one.';
    document.getElementById('submit').setAttribute('disabled', '');
  } else {
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, firstName, lastName, username) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(_apiUrl.apiUrl, "/users/signup"),
              data: {
                email: email,
                firstName: firstName,
                lastName: lastName,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Account is created successfully!\nAn email is sent to you with your password!');
...
},{"axios":"../../node_modules/axios/index.js","./apiUrl":"apiUrl.js","./alert":"alert.js"}],"login.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(_apiUrl.apiUrl, "/users/login"),
              data: {
                email: email,
                password: password
              }
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./apiUrl":"apiUrl.js","./alert":"alert.js"}],"captcha.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tryNewCaptcha = tryNewCaptcha;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(_apiUrl.apiUrl, "/users/logout")
            });
...
},{"axios":"../../node_modules/axios/index.js","./apiUrl":"apiUrl.js","./alert":"alert.js"}],"search.js":[function(require,module,exports) {
"use strict";
...
function dateChecker() {
  ...
  if (checkInDate === '' || checkInDate === null || document.getElementById('DateValidator').innerHTML.length !== 0) {
    document.getElementById('CheckOutDate').value = '';
    (0, _alert.showAlert)('error', 'Please select a valid check in date!');
...
function ValidateForm() {
  if (document.getElementById('DateChecker').innerHTML !== '' || document.getElementById('DateValidator').innerHTML !== '') {
    (0, _alert.showAlert)('error', 'Please check your data');
    return false;
  }

  return true;
}
},{"./alert":"alert.js"}],"updateCurrentUser.js":[function(require,module,exports) {
"use strict";
...
exports.updatePassword = exports.updateCurrentUserData = void 0;
...
function checkPasswords() {
  if (document.getElementById('password').value !== document.getElementById('passwordConfirm').value) {
    document.getElementById('passwordConfirmErrorMessage').innerHTML = '&#x26A0;passwords are not the same';
    document.getElementById('submit').setAttribute('disabled', '');
  } else {
...
var updateCurrentUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(firstName, lastName, email, username) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "".concat(_apiUrl.apiUrl, "/users/updateMe"),
              data: {
                email: email,
                firstName: firstName,
                lastName: lastName,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'your account info has been updated successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
  ...
  return function updateCurrentUserData(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateCurrentUserData = updateCurrentUserData;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "".concat(_apiUrl.apiUrl, "/users/updateMyPassword"),
              data: {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'your password has been changed successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./apiUrl":"apiUrl.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _updateCurrentUser = require("./updateCurrentUser");
...
window.addEventListener('pageshow', function (event) {
  var historyTraversal = event.persisted || typeof window.performance != 'undefined' && window.performance.getEntriesByType('navigation')[0].type === 2;
...
if (window.location.pathname === '/register') {
  ...
  document.getElementById('txtCaptcha').value = code;
  document.getElementById('CaptchaDiv').innerHTML = code;
  document.getElementById('tryNewCaptcha').onclick = _captcha.tryNewCaptcha;
  document.getElementById('email').oninput = _signup.email_validation;
  document.getElementById('username').oninput = _signup.username_validation;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _alert.showAlert)('error', 'The CAPTCHA Code Does Not Match.');
              return _context.abrupt("return", false);

            case 4:
              _context.next = 6;
              return (0, _signup.signup)(form.email.value, form.firstName.value, form.lastName.value, form.username.value);
...
if (window.location.pathname === '/login') {
  var _form = document.querySelector('#login_form');

  document.getElementById('viewOrHidePass').onclick = _login.myFunction;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              event.preventDefault();
              _context2.next = 3;
              return (0, _login.login)(_form.email.value, _form.password.value);
...
if (document.getElementById('signoutForm')) {
  document.getElementById('signoutForm').addEventListener('submit', /*#__PURE__*/function () {
...
if (window.location.pathname === '/home') {
  document.getElementById('CheckInDate').oninput = _search.validateDate;
  document.getElementById('CheckOutDate').oninput = _search.dateChecker;
  document.querySelector('#search').addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              if (!(0, _search.ValidateForm)()) {
                event.preventDefault();
              }

              sessionStorage.setItem('sessionCity', document.getElementById('city').value);
              sessionStorage.setItem('sessionCheckInDate', document.getElementById('CheckInDate').value);
              sessionStorage.setItem('sessionCheckOutDate', document.getElementById('CheckOutDate').value);
              sessionStorage.setItem('sessionNumberOfRooms', document.getElementById('numberOfRooms').value);
              sessionStorage.setItem('sessionNumberOfAdults', document.getElementById('NoOfAdults').value);
              sessionStorage.setItem('sessionNumberOfChildren', document.getElementById('NoOfChildren').value);
...
if (window.location.pathname === '/me') {
  var changeAccountInfoForm = document.getElementById('changeAccountInfo');
  changeAccountInfoForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              event.preventDefault();
              _context5.next = 3;
              return (0, _updateCurrentUser.updateCurrentUserData)(changeAccountInfoForm.firstName.value, changeAccountInfoForm.lastName.value, changeAccountInfoForm.email.value, changeAccountInfoForm.username.value);
  ...
  var updatePasswordForm = document.getElementById('updatePassword');
  document.getElementById('passwordConfirm').oninput = _updateCurrentUser.checkPasswords;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              event.preventDefault();
              _context6.next = 3;
              return (0, _updateCurrentUser.updatePassword)(updatePasswordForm.currentPassword.value, updatePasswordForm.password.value, updatePasswordForm.passwordConfirm.value);
...
},{"./signup":"signup.js","./login":"login.js","./alert":"alert.js","./captcha":"captcha.js","./logout":"logout.js","./search":"search.js","./updateCurrentUser":"updateCurrentUser.js"}]},{},["index.js"], null)
